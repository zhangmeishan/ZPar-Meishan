...
private:
   ...
   CAgendaBeam<depsem::CStateItem> *m_Agenda;
...
public:
   ...
   CDepParser( const std::string &sFeatureDBPath , bool bTrain ) : CDepParserBase(sFeatureDBPath, bTrain) {
      m_Agenda = new CAgendaBeam<depsem::CStateItem>(AGENDA_SIZE);
...
private:
   ...
   inline depsem::SCORE_TYPE updateScoreForState(const CSTackFeatsVec &stackfeats, const depsem::CStateItem &from, const depsem::CStateItem *outout , const depsem::SCORE_TYPE &amount ) ;
