...
#ifndef _GENERAL_DEPSEM_MACROS_H
#define _GENERAL_DEPSEM_MACROS_H
...
//semantic labels without duplicated for the childre of a word
#define SEM_WO_DUPLICATED

//parsing semantic labels only
//#define SEMANTIC_ONLY
