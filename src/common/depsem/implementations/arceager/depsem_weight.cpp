...
void TARGET_LANGUAGE::depsem::CWeight::loadScores() {
...
void TARGET_LANGUAGE::depsem::CWeight::saveScores() {
...
void TARGET_LANGUAGE::depsem::CWeight::computeAverageFeatureWeights(int round) {
...
void TARGET_LANGUAGE::depsem::CWeight::outputScores() {
...
void TARGET_LANGUAGE::depsem::CWeight::addCurrent(CWeight*w, int round) {
   iterate_double_templates(, .addCurrent ID_LRB w-> , ID_COMMA round ID_RRB ;);
}

void TARGET_LANGUAGE::depsem::CWeight::subtractCurrent(CWeight*w, int round) {
