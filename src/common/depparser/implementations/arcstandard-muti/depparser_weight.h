...
#define iterate_templates(left, right) do { \
  ...
  left(S0wtS1t)right; /*  15 -a- S0.t + S1.t  */  \
  left(S0tS1wt)right; /*  15 -b- S0.t + S1.t  */  \
  left(S0wtS1wt)right; /*  15 -c- S0.t + S1.t  */  \
  left(S0wN0w)right; /*  16 - S0.w + N0.w  */  \
  left(S0wN0t)right; /*  17 - S0.w + N0.t  */  \
  left(S0tN0w)right; /*  18 - S0.t + N0.w  */  \
  left(S0tN0t)right; /*  19 - S0.t + N0.t  */  \
  left(S0wtN0t)right; /*  19 -a- S0.t + N0.t  */  \
  left(S0tN0wt)right; /*  19 -b- S0.t + N0.t  */  \
  left(S0tN0tN1t)right; /*  19 -c- S0.t + N0.t  */  \
  left(S1tS0tN0t)right; /*  19 -d- S0.t + N0.t  */  \
  ...
  left(S0wGuide)right;    /* 100 */ \
  left(S0tGuide)right;    /* 101 */ \
  left(S1wGuide)right;    /* 102 */ \
  left(S1tGuide)right;    /* 103 */ \
  left(Guide)right;    /* 104 */ \
  left(DistGuide)right;    /* 104 - a  */ \
  left(S0wS0LGuide)right;    /* 105 */ \
  left(S0tS0LGuide)right;    /* 106 */ \
  left(S1wS0LGuide)right;    /* 107 */ \
  left(S1tS0LGuide)right;    /* 108 */ \
  left(S0LGuide)right;    /* 109 */ \
  left(DistS0LGuide)right;    /* 109 -a */ \
  left(S0wS1LGuide)right;    /* 110 */ \
  left(S0tS1LGuide)right;    /* 111 */ \
  left(S1wS1LGuide)right;    /* 112 */ \
  left(S1tS1LGuide)right;    /* 113 */ \
  left(S1LGuide)right;    /* 114 */ \
  left(DistS1LGuide)right;    /* 114 -a */ \
  left(S0LGuideS1LGuide)right;    /* 115 */ \
  left(S0tS1tGuide)right;    /* 116 */ \
  left(S0tLGuideS1t)right;    /* 117 */ \
  left(S0tS1tLGuide)right;    /* 118 */ \
} while (0);
...
typedef CPackedScoreMap<CTuple3<CWord, CWord, CTag>, SCORE_TYPE, action::kMax> \
  CWordWordTagMap;
typedef CPackedScoreMap<CTuple4<CWord, CWord, CTag, CTag>, SCORE_TYPE, action::kMax> \
  CWordWordTagTagMap;
...
public:
  ...
  CWordTagTagMap  S0wtS1t;       /* 15-a - S0.wt + S1.t */
  CWordTagTagMap  S0tS1wt;       /* 15-b - S0.t + S1.wt */
  CWordWordTagTagMap S0wtS1wt;       /* 15-c - S0.wt + S1.wt */
  ...
  CWordTagTagMap  S0wtN0t;       /* 19-a - S0.wt + N0.t */
  CWordTagTagMap  S0tN0wt;       /* 19-b - S0.t + N0.wt */
  CTagTagTagMap   S0tN0tN1t;       /* 19-c - S0.t + N0.t + N1.t */
  CTagTagTagMap   S1tS0tN0t;       /* 19-d - S1.t + S0.t + N0.t */
  ...
  CWordIntMap           S0wGuide;    /* 100 - S0.w + Guide */
  CTagIntMap            S0tGuide;    /* 101 - S0.t + Guide */
  CWordIntMap           S1wGuide;    /* 102 - S0.w + Guide */
  CTagIntMap            S1tGuide;    /* 103 - S0.t + Guide */
  CIntMap               Guide;       /* 104 - Guide */
  CIntMap               DistGuide;       /* 104 - a - Guide */

  CWordIntMap           S0wS0LGuide;    /* 105 - S0.w + S0Guide */
  CTagIntMap            S0tS0LGuide;    /* 106 - S0.t + S0Guide */
  CWordIntMap           S1wS0LGuide;    /* 107 - S0.w + S0Guide */
  CTagIntMap            S1tS0LGuide;    /* 108 - S0.t + S0Guide */
  CIntMap               S0LGuide;       /* 109 - S0Guide */


  CWordIntMap           S0wS1LGuide;    /* 110 - S0.w + S1Guide */
  CTagIntMap            S0tS1LGuide;    /* 111 - S0.t + S1Guide */
  CWordIntMap           S1wS1LGuide;    /* 112 - S0.w + S1Guide */
  CTagIntMap            S1tS1LGuide;    /* 113 - S0.t + S1Guide */
  CIntMap               S1LGuide;       /* 114 - S1Guide */

  CIntMap               S0LGuideS1LGuide;       /* 115 - S1Guide */

  CIntMap               DistS0LGuide;       /* 109 - a - S0Guide */
  CIntMap               DistS1LGuide;       /* 114 - a - S0Guide */

  CTagTagIntMap         S0tS1tGuide;        /* 116 - S1Guide */
  CTagTagIntMap         S0tLGuideS1t;       /* 117 - S1Guide */
  CTagTagIntMap         S0tS1tLGuide;       /* 118 - S1Guide */
...
public:
  CWeight(const std::string &sPath, bool bTrain)
    ...
    S0wtS1t("15-a-S0.wt+S1.t", DEP_TABLE_SIZE),
    S0tS1wt("15-b-S0.t+S1.wt", DEP_TABLE_SIZE),
    S0wtS1wt("15-c-S0.wt+S1.wt", DEP_TABLE_SIZE),
    ...
    S0wtN0t("19-a-S0.wt+N0.t", DEP_TABLE_SIZE),
    S0tN0wt("19-b-S0.t+N0.wt", DEP_TABLE_SIZE),
    S0tN0tN1t("19-c-S0.t+N0.t+N1.t", DEP_TABLE_SIZE),
    S1tS0tN0t("19-d-S1.t+S0.t+N0.t", DEP_TABLE_SIZE),
    ...
    S0wGuide("100 - S0.w + Guide", DEP_TABLE_SIZE),
    S0tGuide("101 - S0.t + Guide", DEP_TABLE_SIZE),
    S1wGuide("102 - S0.w + Guide", DEP_TABLE_SIZE),
    S1tGuide("103 - S0.t + Guide", DEP_TABLE_SIZE),
    Guide("104 - Guide", DEP_TABLE_SIZE),
    DistGuide("104 -a - DistGuide", DEP_TABLE_SIZE),
    S0wS0LGuide("105 - S0.w + S0LGuide", DEP_TABLE_SIZE),
    S0tS0LGuide("106 - S0.t + S0LGuide", DEP_TABLE_SIZE),
    S1wS0LGuide("107 - S0.w + S0LGuide", DEP_TABLE_SIZE),
    S1tS0LGuide("108 - S0.t + S0LGuide", DEP_TABLE_SIZE),
    S0LGuide("109 - S0LGuide", DEP_TABLE_SIZE),
    DistS0LGuide("109 - a - DistS0LGuide", DEP_TABLE_SIZE),
    S0wS1LGuide("110 - S0.w + S1LGuide", DEP_TABLE_SIZE),
    S0tS1LGuide("111 - S0.t + S1LGuide", DEP_TABLE_SIZE),
    S1wS1LGuide("112 - S0.w + S1LGuide", DEP_TABLE_SIZE),
    S1tS1LGuide("113 - S0.t + S1LGuide", DEP_TABLE_SIZE),
    S1LGuide("114 - S1LGuide", DEP_TABLE_SIZE),
    DistS1LGuide("114 - a - DistS1LGuide", DEP_TABLE_SIZE),
    S0LGuideS1LGuide("115 - S0LGuideS1LGuide", DEP_TABLE_SIZE),
    S0tS1tGuide("116 - S0tS1tGuide", DEP_TABLE_SIZE),
    S0tLGuideS1t("117 - S0tLGuideS1t", DEP_TABLE_SIZE),
    S0tS1tLGuide("118 - S0tS1tLGuide", DEP_TABLE_SIZE){
      loadScores();
  }
