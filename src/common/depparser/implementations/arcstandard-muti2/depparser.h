...
public:
  ...
  void train(const CDependencyParse &correct0,const CDependencyParse &correct1,
             int round);
  ...
  void parse_conll(const CCoNLLInput & sentence,
                   CCoNLLOutput * retval0, CCoNLLOutput * retval1,
                   int nBest = 1,
                   depparser::SCORE_TYPE *scores = 0);

  void train_conll(const CCoNLLOutput &correct0, const CCoNLLOutput &correct1,
                   int round);
  ...
  void updateScores(const CDependencyParse & parse0, const CDependencyParse & parse1,
