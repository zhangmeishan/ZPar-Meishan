...
#define iterate_templates(left, right) do { \
  ...
  left(S0wS0Guide)right;    /* 105 */ \
  left(S0tS0Guide)right;    /* 106 */ \
  left(S1wS0Guide)right;    /* 107 */ \
  left(S1tS0Guide)right;    /* 108 */ \
  left(S0Guide)right;    /* 109 */ \
  left(S0wS1Guide)right;    /* 110 */ \
  left(S0tS1Guide)right;    /* 111 */ \
  left(S1wS1Guide)right;    /* 112 */ \
  left(S1tS1Guide)right;    /* 113 */ \
  left(S1Guide)right;    /* 114 */ \
} while (0);
...
public:
  ...
  CWordIntMap           S0wS0Guide;    /* 105 - S0.w + S0Guide */
  CTagIntMap            S0tS0Guide;    /* 106 - S0.t + S0Guide */
  CWordIntMap           S1wS0Guide;    /* 107 - S0.w + S0Guide */
  CTagIntMap            S1tS0Guide;    /* 108 - S0.t + S0Guide */
  CIntMap               S0Guide;       /* 109 - S0Guide */


  CWordIntMap           S0wS1Guide;    /* 110 - S0.w + S1Guide */
  CTagIntMap            S0tS1Guide;    /* 111 - S0.t + S1Guide */
  CWordIntMap           S1wS1Guide;    /* 112 - S0.w + S1Guide */
  CTagIntMap            S1tS1Guide;    /* 113 - S0.t + S1Guide */
  CIntMap               S1Guide;       /* 114 - S1Guide */
...
public:
  CWeight(const std::string &sPath, bool bTrain)
    ...
    S0wS0Guide("105 - S0.w + S0Guide", DEP_TABLE_SIZE),
    S0tS0Guide("106 - S0.t + S0Guide", DEP_TABLE_SIZE),
    S1wS0Guide("107 - S0.w + S0Guide", DEP_TABLE_SIZE),
    S1tS0Guide("108 - S0.t + S0Guide", DEP_TABLE_SIZE),
    S0Guide("109 - S0Guide", DEP_TABLE_SIZE),
    S0wS1Guide("110 - S0.w + S1Guide", DEP_TABLE_SIZE),
    S0tS1Guide("111 - S0.t + S1Guide", DEP_TABLE_SIZE),
    S1wS1Guide("112 - S0.w + S1Guide", DEP_TABLE_SIZE),
    S1tS1Guide("113 - S0.t + S1Guide", DEP_TABLE_SIZE),
    S1Guide("114 - S1Guide", DEP_TABLE_SIZE){
      loadScores();
  }
