...
\
  ...
  left(N0tGuide)right \
  left(Guide)right \
  left(S0wS0Guide)right \
  left(S0tS0Guide)right \
  left(N0wS0Guide)right \
  left(N0tS0Guide)right \
  left(S0Guide)right \
  left(S0wN0Guide)right \
  left(S0tN0Guide)right \
  left(N0wN0Guide)right \
  left(N0tN0Guide)right \
  left(N0Guide)right \
...
public:
   ...
   CWordIntMap           N0wGuide;    /* 102 - S0.w + Guide */
   CTagIntMap            N0tGuide;    /* 103 - S0.t + Guide */
   CIntMap               Guide;       /* 104 - Guide */

   CWordIntMap           S0wS0Guide;    /* 105 - S0.w + S0Guide */
   CTagIntMap            S0tS0Guide;    /* 106 - S0.t + S0Guide */
   CWordIntMap           N0wS0Guide;    /* 107 - S0.w + S0Guide */
   CTagIntMap            N0tS0Guide;    /* 108 - S0.t + S0Guide */
   CIntMap               S0Guide;       /* 109 - S0Guide */


   CWordIntMap           S0wN0Guide;    /* 110 - S0.w + N0Guide */
   CTagIntMap            S0tN0Guide;    /* 111 - S0.t + N0Guide */
   CWordIntMap           N0wN0Guide;    /* 112 - S0.w + N0Guide */
   CTagIntMap            N0tN0Guide;    /* 113 - S0.t + N0Guide */
   CIntMap               N0Guide;       /* 114 - N0Guide */
...
public:
   ...
   CWeight(const std::string &sPath, bool bTrain) : CWeightBase(sPath, bTrain) ,
                                               ...
                                               N0wGuide("102 - S0.w + Guide", DEP_TABLE_SIZE),
                                               N0tGuide("103 - S0.t + Guide", DEP_TABLE_SIZE),
                                               Guide("104 - Guide", DEP_TABLE_SIZE),
                                               S0wS0Guide("105 - S0.w + S0Guide", DEP_TABLE_SIZE),
                                               S0tS0Guide("106 - S0.t + S0Guide", DEP_TABLE_SIZE),
                                               N0wS0Guide("107 - S0.w + S0Guide", DEP_TABLE_SIZE),
                                               N0tS0Guide("108 - S0.t + S0Guide", DEP_TABLE_SIZE),
                                               S0Guide("109 - S0Guide", DEP_TABLE_SIZE),
                                               S0wN0Guide("110 - S0.w + N0Guide", DEP_TABLE_SIZE),
                                               S0tN0Guide("111 - S0.t + N0Guide", DEP_TABLE_SIZE),
                                               N0wN0Guide("112 - S0.w + N0Guide", DEP_TABLE_SIZE),
                                               N0tN0Guide("113 - S0.t + N0Guide", DEP_TABLE_SIZE),
                                               N0Guide("114 - N0Guide", DEP_TABLE_SIZE)
   { loadScores(); }
