...
enum STACK_ACTION { NO_ACTION=0, SHIFT0, SHIFT1, REDUCE0, REDUCE1,
    ARC_LEFT, ARC_RIGHT, POP_ROOT0, POP_ROOT1,
    LABEL_AL_FIRST, LABEL_AR_FIRST=LABEL_AL_FIRST+DEP_LABEL_COUNT-1, MAX=LABEL_AR_FIRST+DEP_LABEL_COUNT-1 };
