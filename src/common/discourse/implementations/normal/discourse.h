...
private:
   ...
   inline discourse::SCORE_TYPE getOrUpdateStackScore( discourse::CWeight *cast_weights, const discourse::CStateItem *item, const discourse::CAction &action, discourse::SCORE_TYPE amount=0, int round=0 );
   inline void getOrUpdateScore(const discourse::CStateItem &item, const discourse::CAction &action=discourse::CAction(), discourse::SCORE_TYPE amount=0, int round=0 );
