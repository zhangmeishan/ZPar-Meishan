...
/****************************************************************
 *                                                              *
 * supertag.h - the supertags for dependency translator in general  *
 *                                                              *
 * Author: Yue Zhang                                            *
 *                                                              *
 ****************************************************************/

#ifndef _MACHINETRANS_STACKFEAT_H
#define _MACHINETRANS_STACKFEAT_H
...
//std::ostream & operator << (std::ostream &os, const TARGET_LANGUAGE::deptranslator::CSuperTag &p) {
