...
\
    left(m_mapPrefixChar4)right\
    left(m_mapSuffixChar4)right\
...
typedef CPackedScoreMap<CTuple4<CWord, CWord, CWord, CWord>, SCORE_TYPE, action::MAX> CWordWordWordWordMap;
...
public:
	...
	CWordTagMap m_mapST0tN0w;
	   ...
	   CWordWordWordWordMap m_mapPrefixChar4;
	   CWordWordWordWordMap m_mapSuffixChar4;
	   CLongIntMap  m_mapContainHyphen;
	   CLongIntMap  m_mapContainNumber;
	   CLongIntMap  m_mapContainCapitalLetter;
...
public:
   ...
   CWeight(const std::string &sPath, bool bTrain) : CWeightBase(sPath, bTrain) ,
										   ...
										   m_mapPrefixChar4("StackingRIGHT1ST0tST1t", DEP_TABLE_SIZE),
										   m_mapSuffixChar4("StackingRIGHT2ST0tST1t", DEP_TABLE_SIZE),
										   m_mapContainHyphen("StackingRIGHT1and2ST0tST1t", DEP_TABLE_SIZE),
										   m_mapContainNumber("StackingRIGHT1ST0t", DEP_TABLE_SIZE),
										   m_mapContainCapitalLetter("StackingRIGHT2ST0t", DEP_TABLE_SIZE)
   { loadScores(); }
