...
public:
   ...
   enum CODE {NO_ACTION=0, SHIFT_S=1, SHIFT_A=2, WORD_XYZ=3, WORD_T=4, SHIFT= 5, REDUCE_BINARY=6, REDUCE_UNARY=7, POP_ROOT=8, IDLE=9};
...
public:
   ...
   inline bool isShiftInner() const { return type()==CActionType::SHIFT_S || type()==CActionType::SHIFT_A; }
