...
public:
   ...
   virtual bool train(const CStringVector *sentence , const CSTackFeatsVec  & stackfeats, const CTwoStringVector *correct) = 0;
   void dumpfeatures(const CStringVector *sentence , const CSTackFeatsVec  & stackfeats, const CTwoStringVector *correct)  {
      THROW("Not supported.");
   }
   ...
   virtual void tag(const CStringVector *sentence , const CSTackFeatsVec  & stackfeats, CTwoStringVector *retval, double *out_scores=NULL, unsigned long nBest=1, const CBitArray *word_ends=NULL) = 0;
