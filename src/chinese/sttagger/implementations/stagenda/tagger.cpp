...
SCORE_TYPE CTagger::getOrUpdateSeparateScore( const CStringVector *sentence , const CSTackFeatsVec  & stackfeats, const CSubStateItem *item, unsigned long index, SCORE_TYPE amount, unsigned long round ) {
...
/*
   const CWord &segfeat_0 = CWord(stackfeats[start_0].m_feats1[0], amount!=0);
   const CWord &posfeat_0 = CWord(stackfeats[start_0].m_feats2[0]+"#"+tag_0.str(), amount!=0);
   const CWord &segposfeat_0 = CWord(stackfeats[start_0].m_feats1[0]+"#"+stackfeats[start_0].m_feats2[0]+"#"+tag_0.str(), amount!=0);
   const CWord &segfeat_1 = start_0>0 ? CWord(stackfeats[start_0-1].m_feats1[0], amount!=0) : g_emptyWord;
   const CWord &posfeat_1 = start_0>0 ? CWord(stackfeats[start_0-1].m_feats2[0]+"#"+tag_1.str(), amount!=0) : g_emptyWord;
   const CWord &segposfeat_1 = start_0>0 ? CWord(stackfeats[start_0-1].m_feats1[0]+"#"+stackfeats[start_0-1].m_feats2[0]+"#"+tag_1.str(), amount!=0) : g_emptyWord;
   const CWord &segfeat_0_segfeat_1 = start_0>0 ? CWord(stackfeats[start_0].m_feats1[0]+"#"+stackfeats[start_0-1].m_feats1[0], amount!=0) : g_emptyWord;
   const CWord &posfeat_0_posfeat_1 = start_0>0 ? CWord(stackfeats[start_0].m_feats2[0]+"#"+tag_0.str()+"#"+stackfeats[start_0-1].m_feats2[0]+"#"+tag_1.str(), amount!=0) : g_emptyWord;

   static CTwoWords twochar_segfeat_0, first_char_0_segfeat_0;
   static CTwoWords twochar_segfeat_1, first_char_0_segfeat_1;
   static CTwoWords twochar_posfeat_0, first_char_0_posfeat_0;
   static CTwoWords twochar_posfeat_1, first_char_0_posfeat_1;

   static CTwoWords twochar_segposfeat_0, first_char_0_segposfeat_0;
   static CTwoWords twochar_segposfeat_1, first_char_0_segposfeat_1;
   static CTwoWords twochar_segfeat_0_segfeat_1, first_char_0_segfeat_0_segfeat_1;
   static CTwoWords twochar_posfeat_0_posfeat_1, first_char_0_posfeat_0_posfeat_1;


   if (amount==0&&index>0) {
      twochar_segfeat_0.refer( &two_char, &segfeat_0 ) ;
      twochar_segfeat_1.refer( &two_char, &segfeat_1 ) ;
      twochar_posfeat_0.refer( &two_char, &posfeat_0 ) ;
      twochar_posfeat_1.refer( &two_char, &posfeat_1 ) ;
      twochar_segposfeat_0.refer( &two_char, &segposfeat_0 ) ;
      twochar_segposfeat_1.refer( &two_char, &segposfeat_1 ) ;
      twochar_segfeat_0_segfeat_1.refer( &two_char, &segfeat_0_segfeat_1 ) ;
      twochar_posfeat_0_posfeat_1.refer( &two_char, &posfeat_0_posfeat_1 ) ;
      first_char_0_segfeat_1.refer( &first_char_0, &segfeat_1 ) ;
      first_char_0_posfeat_1.refer( &first_char_0, &posfeat_1 ) ;
      first_char_0_segposfeat_1.refer( &first_char_0, &segposfeat_1 ) ;
      first_char_0_segfeat_0_segfeat_1.refer( &first_char_0, &segfeat_0_segfeat_1 ) ;
      first_char_0_posfeat_0_posfeat_1.refer( &first_char_0, &posfeat_0_posfeat_1 ) ;
   }
   else {
      twochar_segfeat_0.allocate( two_char, segfeat_0 ) ;
      twochar_segfeat_1.allocate( two_char, segfeat_1 ) ;
      twochar_posfeat_0.allocate( two_char, posfeat_0 ) ;
      twochar_posfeat_1.allocate( two_char, posfeat_1 ) ;
      twochar_segposfeat_0.allocate( two_char, segposfeat_0 ) ;
      twochar_segposfeat_1.allocate( two_char, segposfeat_1 ) ;
      twochar_segfeat_0_segfeat_1.allocate( two_char, segfeat_0_segfeat_1 ) ;
      twochar_posfeat_0_posfeat_1.allocate( two_char, posfeat_0_posfeat_1 ) ;
      first_char_0_segfeat_1.allocate( first_char_0, segfeat_1 ) ;
      first_char_0_posfeat_1.allocate( first_char_0, posfeat_1 ) ;
      first_char_0_segposfeat_1.allocate( first_char_0, segposfeat_1 ) ;
      first_char_0_segfeat_0_segfeat_1.allocate( first_char_0, segfeat_0_segfeat_1 ) ;
      first_char_0_posfeat_0_posfeat_1.allocate( first_char_0, posfeat_0_posfeat_1 ) ;
   }


   if (amount==0) {
      first_char_0_segfeat_0.refer( &first_char_0, &segfeat_0 ) ;
      first_char_0_posfeat_0.refer( &first_char_0, &posfeat_0 ) ;
      first_char_0_segposfeat_0.refer( &first_char_0, &segposfeat_0 ) ;
   }
   else {
      first_char_0_segfeat_0.allocate( first_char_0, segfeat_0 ) ;
      first_char_0_posfeat_0.allocate( first_char_0, posfeat_0 ) ;
      first_char_0_segposfeat_0.allocate( first_char_0, segposfeat_0 ) ;
   }
*/
   static int j ; 
...
/*
    if(index>0)
    {
        nReturn += m_weights->m_mapSegFeat1.getOrUpdateScore( segfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapPosFeat1.getOrUpdateScore( posfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapSegPosFeat1.getOrUpdateScore( segposfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapSegFeat0SegFeat1.getOrUpdateScore( segfeat_0_segfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapPosFeat0PosFeat1.getOrUpdateScore( posfeat_0_posfeat_1 , m_nScoreIndex , amount , round ) ;

        nReturn += m_weights->m_mapTwoCharSegFeat0.getOrUpdateScore( twochar_segfeat_0 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapTwoCharSegFeat1.getOrUpdateScore( twochar_segfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapTwoCharPosFeat0.getOrUpdateScore( twochar_posfeat_0 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapTwoCharPosFeat1.getOrUpdateScore( twochar_posfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapTwoCharSegPosFeat0.getOrUpdateScore( twochar_segposfeat_0 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapTwoCharSegPosFeat1.getOrUpdateScore( twochar_segposfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapTwoCharSegFeat0SegFeat1.getOrUpdateScore( twochar_segfeat_0_segfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapTwoCharPosFeat0PosFeat1.getOrUpdateScore( twochar_posfeat_0_posfeat_1 , m_nScoreIndex , amount , round ) ;



        nReturn += m_weights->m_mapFirstChar0SegFeat1.getOrUpdateScore( first_char_0_segfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapFirstChar0PosFeat1.getOrUpdateScore( first_char_0_posfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapFirstChar0SegPosFeat1.getOrUpdateScore( first_char_0_segposfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapFirstChar0SegFeat0SegFeat1.getOrUpdateScore( first_char_0_segfeat_0_segfeat_1 , m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapFirstChar0PosFeat0PosFeat1.getOrUpdateScore( first_char_0_posfeat_0_posfeat_1 , m_nScoreIndex , amount , round ) ;

    }

    nReturn += m_weights->m_mapSegFeat0.getOrUpdateScore( segfeat_0 , m_nScoreIndex , amount , round ) ;
    nReturn += m_weights->m_mapPosFeat0.getOrUpdateScore( posfeat_0 , m_nScoreIndex , amount , round ) ;
    nReturn += m_weights->m_mapSegPosFeat0.getOrUpdateScore( segposfeat_0 , m_nScoreIndex , amount , round ) ;
    nReturn += m_weights->m_mapFirstChar0SegFeat0.getOrUpdateScore( first_char_0_segfeat_0 , m_nScoreIndex , amount , round ) ;
    nReturn += m_weights->m_mapFirstChar0PosFeat0.getOrUpdateScore( first_char_0_posfeat_0 , m_nScoreIndex , amount , round ) ;
    nReturn += m_weights->m_mapFirstChar0SegPosFeat0.getOrUpdateScore( first_char_0_segposfeat_0 , m_nScoreIndex , amount , round ) ;
*/


    unsigned long long fixedid = 1;
    if(stackfeats[start_0].m_feats1[0] == "B0")
    {
        nReturn += m_weights->m_mapSEPB.getOrUpdateScore( fixedid, m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapSEPBTagByChar.getOrUpdateScore( std::make_pair(first_char_0, tag_0), m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapSEPBLastTagByTag.getOrUpdateScore( tag_0_tag_1, m_nScoreIndex , amount , round ) ;
        if (index>0) {
           nReturn = m_weights->m_mapSEPBSeenWords.getOrUpdateScore( word_1 , m_nScoreIndex , amount , round ) ;
           nReturn += m_weights->m_mapSEPBTwoChars.getOrUpdateScore( two_char , m_nScoreIndex , amount , round ) ;
           //nReturn += m_weights->m_mapSEPBLastWordFirstChar.getOrUpdateScore( word_1_first_char_0 , m_nScoreIndex , amount , round ) ;
        }
    }


    if(stackfeats[start_0].m_feats1[0] == "C0")
    {
        nReturn += m_weights->m_mapSEPA.getOrUpdateScore( fixedid, m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapSEPATagByChar.getOrUpdateScore( std::make_pair(first_char_0, tag_0), m_nScoreIndex , amount , round ) ;
        nReturn += m_weights->m_mapSEPALastTagByTag.getOrUpdateScore( tag_0_tag_1, m_nScoreIndex , amount , round ) ;
        if (index>0) {
           nReturn = m_weights->m_mapSEPASeenWords.getOrUpdateScore( word_1 , m_nScoreIndex , amount , round ) ;
           nReturn += m_weights->m_mapSEPATwoChars.getOrUpdateScore( two_char , m_nScoreIndex , amount , round ) ;
           //nReturn += m_weights->m_mapSEPALastWordFirstChar.getOrUpdateScore( word_1_first_char_0 , m_nScoreIndex , amount , round ) ;
        }
    }
...
SCORE_TYPE CTagger::getOrUpdateAppendScore( const CStringVector *sentence , const CSTackFeatsVec  & stackfeats, const CSubStateItem *item, unsigned long index, unsigned long char_index, SCORE_TYPE amount, unsigned long round ) {
   static SCORE_TYPE nReturn ; 
   assert(char_index>0);
   ...
   /*
   const CWord &segfeat_0 = CWord(stackfeats[char_index].m_feats1[0], amount!=0);
   const CWord &posfeat_0 = CWord(stackfeats[char_index].m_feats2[0]+"#"+tag_0.str(), amount!=0);
   const CWord &segposfeat_0 = CWord(stackfeats[char_index].m_feats1[0]+"#"+stackfeats[char_index].m_feats2[0]+"#"+tag_0.str(), amount!=0);
   const CWord &segfeat_1 = char_index>0 ? CWord(stackfeats[char_index-1].m_feats1[0], amount!=0) : g_emptyWord;
   const CWord &posfeat_1 = char_index>0 ? CWord(stackfeats[char_index-1].m_feats2[0]+"#"+tag_0.str(), amount!=0) : g_emptyWord;
   const CWord &segposfeat_1 = char_index>0 ? CWord(stackfeats[char_index-1].m_feats1[0]+"#"+stackfeats[char_index-1].m_feats2[0]+"#"+tag_0.str(), amount!=0) : g_emptyWord;
   const CWord &segfeat_0_segfeat_1 = char_index>0 ? CWord(stackfeats[char_index].m_feats1[0]+"#"+stackfeats[char_index-1].m_feats1[0], amount!=0) : g_emptyWord;
   const CWord &posfeat_0_posfeat_1 = char_index>0 ? CWord(stackfeats[char_index].m_feats2[0]+"#"+stackfeats[char_index-1].m_feats2[0]+"#"+tag_0.str(), amount!=0) : g_emptyWord;

   static CTwoWords twochar_segfeat_0, char_unigram_segfeat_0;
   static CTwoWords twochar_segfeat_1, char_unigram_segfeat_1;
   static CTwoWords twochar_posfeat_0, char_unigram_posfeat_0;
   static CTwoWords twochar_posfeat_1, char_unigram_posfeat_1;

   static CTwoWords twochar_segposfeat_0, char_unigram_segposfeat_0;
   static CTwoWords twochar_segposfeat_1, char_unigram_segposfeat_1;
   static CTwoWords twochar_segfeat_0_segfeat_1, char_unigram_segfeat_0_segfeat_1;
   static CTwoWords twochar_posfeat_0_posfeat_1, char_unigram_posfeat_0_posfeat_1;


   if (amount==0&&char_index>0) {
      twochar_segfeat_0.refer( &char_bigram, &segfeat_0 ) ;
      twochar_segfeat_1.refer( &char_bigram, &segfeat_1 ) ;
      twochar_posfeat_0.refer( &char_bigram, &posfeat_0 ) ;
      twochar_posfeat_1.refer( &char_bigram, &posfeat_1 ) ;
      twochar_segposfeat_0.refer( &char_bigram, &segposfeat_0 ) ;
      twochar_segposfeat_1.refer( &char_bigram, &segposfeat_1 ) ;
      twochar_segfeat_0_segfeat_1.refer( &char_bigram, &segfeat_0_segfeat_1 ) ;
      twochar_posfeat_0_posfeat_1.refer( &char_bigram, &posfeat_0_posfeat_1 ) ;
      char_unigram_segfeat_1.refer( &char_unigram, &segfeat_1 ) ;
      char_unigram_posfeat_1.refer( &char_unigram, &posfeat_1 ) ;
      char_unigram_segposfeat_1.refer( &char_unigram, &segposfeat_1 ) ;
      char_unigram_segfeat_0_segfeat_1.refer( &char_unigram, &segfeat_0_segfeat_1 ) ;
      char_unigram_posfeat_0_posfeat_1.refer( &char_unigram, &posfeat_0_posfeat_1 ) ;
   }
   else {
      twochar_segfeat_0.allocate( char_bigram, segfeat_0 ) ;
      twochar_segfeat_1.allocate( char_bigram, segfeat_1 ) ;
      twochar_posfeat_0.allocate( char_bigram, posfeat_0 ) ;
      twochar_posfeat_1.allocate( char_bigram, posfeat_1 ) ;
      twochar_segposfeat_0.allocate( char_bigram, segposfeat_0 ) ;
      twochar_segposfeat_1.allocate( char_bigram, segposfeat_1 ) ;
      twochar_segfeat_0_segfeat_1.allocate( char_bigram, segfeat_0_segfeat_1 ) ;
      twochar_posfeat_0_posfeat_1.allocate( char_bigram, posfeat_0_posfeat_1 ) ;
      char_unigram_segfeat_1.allocate( char_unigram, segfeat_1 ) ;
      char_unigram_posfeat_1.allocate( char_unigram, posfeat_1 ) ;
      char_unigram_segposfeat_1.allocate( char_unigram, segposfeat_1 ) ;
      char_unigram_segfeat_0_segfeat_1.allocate( char_unigram, segfeat_0_segfeat_1 ) ;
      char_unigram_posfeat_0_posfeat_1.allocate( char_unigram, posfeat_0_posfeat_1 ) ;
   }


   if (amount==0) {
      char_unigram_segfeat_0.refer( &char_unigram, &segfeat_0 ) ;
      char_unigram_posfeat_0.refer( &char_unigram, &posfeat_0 ) ;
      char_unigram_segposfeat_0.refer( &char_unigram, &segposfeat_0 ) ;
   }
   else {
      char_unigram_segfeat_0.allocate( char_unigram, segfeat_0 ) ;
      char_unigram_posfeat_0.allocate( char_unigram, posfeat_0 ) ;
      char_unigram_segposfeat_0.allocate( char_unigram, segposfeat_0 ) ;
   }
*/
...
//   }
   ...
   if(index>0)
   {
       nReturn += m_weights->m_mapAppSegFeat1.getOrUpdateScore( segfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppPosFeat1.getOrUpdateScore( posfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppSegPosFeat1.getOrUpdateScore( segposfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppSegFeat0SegFeat1.getOrUpdateScore( segfeat_0_segfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppPosFeat0PosFeat1.getOrUpdateScore( posfeat_0_posfeat_1 , m_nScoreIndex , amount , round ) ;

       nReturn += m_weights->m_mapAppTwoCharSegFeat0.getOrUpdateScore( twochar_segfeat_0 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppTwoCharSegFeat1.getOrUpdateScore( twochar_segfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppTwoCharPosFeat0.getOrUpdateScore( twochar_posfeat_0 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppTwoCharPosFeat1.getOrUpdateScore( twochar_posfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppTwoCharSegPosFeat0.getOrUpdateScore( twochar_segposfeat_0 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppTwoCharSegPosFeat1.getOrUpdateScore( twochar_segposfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppTwoCharSegFeat0SegFeat1.getOrUpdateScore( twochar_segfeat_0_segfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppTwoCharPosFeat0PosFeat1.getOrUpdateScore( twochar_posfeat_0_posfeat_1 , m_nScoreIndex , amount , round ) ;



       nReturn += m_weights->m_mapAppFirstChar0SegFeat1.getOrUpdateScore( char_unigram_segfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppFirstChar0PosFeat1.getOrUpdateScore( char_unigram_posfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppFirstChar0SegPosFeat1.getOrUpdateScore( char_unigram_segposfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppFirstChar0SegFeat0SegFeat1.getOrUpdateScore( char_unigram_segfeat_0_segfeat_1 , m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAppFirstChar0PosFeat0PosFeat1.getOrUpdateScore( char_unigram_posfeat_0_posfeat_1 , m_nScoreIndex , amount , round ) ;

   }

   nReturn += m_weights->m_mapAppSegFeat0.getOrUpdateScore( segfeat_0 , m_nScoreIndex , amount , round ) ;
   nReturn += m_weights->m_mapAppPosFeat0.getOrUpdateScore( posfeat_0 , m_nScoreIndex , amount , round ) ;
   nReturn += m_weights->m_mapAppSegPosFeat0.getOrUpdateScore( segposfeat_0 , m_nScoreIndex , amount , round ) ;
   nReturn += m_weights->m_mapAppFirstChar0SegFeat0.getOrUpdateScore( char_unigram_segfeat_0 , m_nScoreIndex , amount , round ) ;
   nReturn += m_weights->m_mapAppFirstChar0PosFeat0.getOrUpdateScore( char_unigram_posfeat_0 , m_nScoreIndex , amount , round ) ;
   nReturn += m_weights->m_mapAppFirstChar0SegPosFeat0.getOrUpdateScore( char_unigram_segposfeat_0 , m_nScoreIndex , amount , round ) ;
*/
   unsigned long long fixedid = 1;
   if(stackfeats[char_index].m_feats1[0] == "B0")
   {
       nReturn += m_weights->m_mapAPPB.getOrUpdateScore( fixedid, m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAPPBTagByChar.getOrUpdateScore( std::make_pair(char_unigram, tag_0), m_nScoreIndex , amount , round ) ;
       if (index>0) {
           m_weights->m_mapAPPBConsecutiveChars.getOrUpdateScore( char_bigram, m_nScoreIndex, amount, round ) ;
       }
   }


   if(stackfeats[char_index].m_feats1[0] == "C0")
   {
       nReturn += m_weights->m_mapAPPB.getOrUpdateScore( fixedid, m_nScoreIndex , amount , round ) ;
       nReturn += m_weights->m_mapAPPATagByChar.getOrUpdateScore( std::make_pair(char_unigram, tag_0), m_nScoreIndex , amount , round ) ;
       if (index>0) {
           m_weights->m_mapAPPAConsecutiveChars.getOrUpdateScore( char_bigram, m_nScoreIndex, amount, round ) ;
       }
   }
...
bool CTagger::train( const CStringVector * sentence_input , const CSTackFeatsVec  & stackfeats , const CTwoStringVector * correct) {
   ++m_nTrainingRound ;
...
//           !m_weights->m_Knowledge->isFWorCD(chars[chars.size()-1])))
   ...
   work( &sentence, stackfeats, NULL, NULL, 1, NULL );
...
void CTagger::tag( const CStringVector * sentence_input , const CSTackFeatsVec  & stackfeats  , CTwoStringVector * vReturn , SCORE_TYPE * out_scores , unsigned long nBest,const CBitArray * prunes ) {
   static CStringVector sentence;
   m_weights->m_rules.segment(sentence_input, &sentence);
   work( &sentence, stackfeats, vReturn, out_scores, nBest, prunes ) ;
}
...
void CTagger::work( const CStringVector * sentence , const CSTackFeatsVec  & stackfeats  , CTwoStringVector * vReturn , SCORE_TYPE * out_scores , unsigned long nBest, const CBitArray * prunes ) {
...
//            writer.writeSentence(&tmp);
            updateScoreForState(sentence, stackfeats, pGenerator, -1);
            updateScoreForState(sentence, stackfeats, &goldState, 1);
      ...
      if ( index > 0 ) {
         ...
         for (j=0; j<m_Agenda.generatorSize(); ++j) {
            ...
            if ( ( m_weights->m_rules.canAppend(index) ) && // ( index > 0 ) &&
               ...
               tempState.score += getOrUpdateAppendScore(sentence, stackfeats, &tempState, tempState.size()-1, index);
               if (index+1==length) tempState.score += getOrUpdateSeparateScore(sentence, stackfeats, &tempState, tempState.size());
               m_Agenda.pushCandidate(&tempState);
            } // if
            pGenerator = m_Agenda.generatorNext();  // next generator
         }
      ...
      for (tag=CTag::FIRST; tag<CTag::COUNT; ++tag) {
         ...
         for (j=0; j<m_Agenda.generatorSize(); ++j) {
            ...
            if ( m_weights->m_rules.canSeparate( index ) && 
               ...
               tempState.score += getOrUpdateSeparateScore(sentence, stackfeats, &tempState, tempState.size()-1);
               if (index+1==length) tempState.score += getOrUpdateSeparateScore(sentence, stackfeats, &tempState, tempState.size());
