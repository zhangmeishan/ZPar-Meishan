...
typedef CScoreMap< unsigned long long, SCORE_TYPE > CIntMap;
...
public:
   ...
   CWordMap m_mapSegFeat1;
   CWordMap m_mapPosFeat1;
   CWordMap m_mapSegPosFeat1;
   CWordMap m_mapSegFeat0SegFeat1;
   CWordMap m_mapPosFeat0PosFeat1;
   CTwoWordsMap m_mapTwoCharSegFeat0;
   CTwoWordsMap m_mapTwoCharSegFeat1;
   CTwoWordsMap m_mapTwoCharPosFeat0;
   CTwoWordsMap m_mapTwoCharPosFeat1;
   CTwoWordsMap m_mapTwoCharSegPosFeat0;
   CTwoWordsMap m_mapTwoCharSegPosFeat1;
   CTwoWordsMap m_mapTwoCharSegFeat0SegFeat1;
   CTwoWordsMap m_mapTwoCharPosFeat0PosFeat1;
   CTwoWordsMap m_mapFirstChar0SegFeat1;
   CTwoWordsMap m_mapFirstChar0PosFeat1;
   CTwoWordsMap m_mapFirstChar0SegPosFeat1;
   CTwoWordsMap m_mapFirstChar0SegFeat0SegFeat1;
   CTwoWordsMap m_mapFirstChar0PosFeat0PosFeat1;
   CWordMap m_mapSegFeat0;
   CWordMap m_mapPosFeat0;
   CWordMap m_mapSegPosFeat0;
   CTwoWordsMap m_mapFirstChar0SegFeat0;
   CTwoWordsMap m_mapFirstChar0PosFeat0;
   CTwoWordsMap m_mapFirstChar0SegPosFeat0;


   CWordMap m_mapAppSegFeat1;
   CWordMap m_mapAppPosFeat1;
   CWordMap m_mapAppSegPosFeat1;
   CWordMap m_mapAppSegFeat0SegFeat1;
   CWordMap m_mapAppPosFeat0PosFeat1;
   CTwoWordsMap m_mapAppTwoCharSegFeat0;
   CTwoWordsMap m_mapAppTwoCharSegFeat1;
   CTwoWordsMap m_mapAppTwoCharPosFeat0;
   CTwoWordsMap m_mapAppTwoCharPosFeat1;
   CTwoWordsMap m_mapAppTwoCharSegPosFeat0;
   CTwoWordsMap m_mapAppTwoCharSegPosFeat1;
   CTwoWordsMap m_mapAppTwoCharSegFeat0SegFeat1;
   CTwoWordsMap m_mapAppTwoCharPosFeat0PosFeat1;
   CTwoWordsMap m_mapAppFirstChar0SegFeat1;
   CTwoWordsMap m_mapAppFirstChar0PosFeat1;
   CTwoWordsMap m_mapAppFirstChar0SegPosFeat1;
   CTwoWordsMap m_mapAppFirstChar0SegFeat0SegFeat1;
   CTwoWordsMap m_mapAppFirstChar0PosFeat0PosFeat1;
   CWordMap m_mapAppSegFeat0;
   CWordMap m_mapAppPosFeat0;
   CWordMap m_mapAppSegPosFeat0;
   CTwoWordsMap m_mapAppFirstChar0SegFeat0;
   CTwoWordsMap m_mapAppFirstChar0PosFeat0;
   CTwoWordsMap m_mapAppFirstChar0SegPosFeat0;


   CIntMap  m_mapSEPB;
   CWordTagMap m_mapSEPBTagByChar;
   CTagSet2Map m_mapSEPBLastTagByTag;
   CWordMap    m_mapSEPBSeenWords;
   CWordMap    m_mapSEPBTwoChars;
   CIntMap m_mapSEPA;
   CWordTagMap m_mapSEPATagByChar;
   CTagSet2Map m_mapSEPALastTagByTag;
   CWordMap    m_mapSEPASeenWords;
   CWordMap    m_mapSEPATwoChars;
   CIntMap m_mapAPPB;
   CWordTagMap m_mapAPPBTagByChar;
   CWordMap    m_mapAPPBConsecutiveChars;
   CIntMap m_mapAPPA;
   CWordTagMap m_mapAPPATagByChar;
   CWordMap    m_mapAPPAConsecutiveChars;
...
public:
   ...
   CWeight(const std::string &sFeatureDB, bool bTrain, bool bSegmentationRules, int hash_table_size) : 
            ...
            m_mapSegFeat1("SegFeat1", 65537),
            m_mapPosFeat1("PosFeat1", 65537),
            m_mapSegPosFeat1("SegPosFeat1", 65537),
            m_mapSegFeat0SegFeat1("SegFeat0SegFeat1", 65537),
            m_mapPosFeat0PosFeat1("PosFeat0PosFeat1", 65537),
            m_mapTwoCharSegFeat0("TwoCharSegFeat0", 65537),
            m_mapTwoCharSegFeat1("TwoCharSegFeat1", 65537),
            m_mapTwoCharPosFeat0("TwoCharPosFeat0", 65537),
            m_mapTwoCharPosFeat1("TwoCharPosFeat1", 65537),
            m_mapTwoCharSegPosFeat0("TwoCharSegPosFeat0", 65537),
            m_mapTwoCharSegPosFeat1("TwoCharSegPosFeat1", 65537),
            m_mapTwoCharSegFeat0SegFeat1("TwoCharSegFeat0SegFeat1", 65537),
            m_mapTwoCharPosFeat0PosFeat1("TwoCharPosFeat0PosFeat1", 65537),
            m_mapFirstChar0SegFeat1("FirstChar0SegFeat1", 65537),
            m_mapFirstChar0PosFeat1("FirstChar0PosFeat1", 65537),
            m_mapFirstChar0SegPosFeat1("FirstChar0SegPosFeat1", 65537),
            m_mapFirstChar0SegFeat0SegFeat1("FirstChar0SegFeat0SegFeat1", 65537),
            m_mapFirstChar0PosFeat0PosFeat1("FirstChar0PosFeat0PosFeat1", 65537),
            m_mapSegFeat0("SegFeat0", 65537),
            m_mapPosFeat0("PosFeat0", 65537),
            m_mapSegPosFeat0("SegPosFeat0", 65537),
            m_mapFirstChar0SegFeat0("FirstChar0SegFeat0", 65537),
            m_mapFirstChar0PosFeat0("FirstChar0PosFeat0", 65537),
            m_mapFirstChar0SegPosFeat0("FirstChar0SegPosFeat0", 65537),
            m_mapAppSegFeat1("AppSegFeat1", 65537),
            m_mapAppPosFeat1("AppPosFeat1", 65537),
            m_mapAppSegPosFeat1("AppSegPosFeat1", 65537),
            m_mapAppSegFeat0SegFeat1("AppSegFeat0SegFeat1", 65537),
            m_mapAppPosFeat0PosFeat1("AppPosFeat0PosFeat1", 65537),
            m_mapAppTwoCharSegFeat0("AppTwoCharSegFeat0", 65537),
            m_mapAppTwoCharSegFeat1("AppTwoCharSegFeat1", 65537),
            m_mapAppTwoCharPosFeat0("AppTwoCharPosFeat0", 65537),
            m_mapAppTwoCharPosFeat1("AppTwoCharPosFeat1", 65537),
            m_mapAppTwoCharSegPosFeat0("AppTwoCharSegPosFeat0", 65537),
            m_mapAppTwoCharSegPosFeat1("AppTwoCharSegPosFeat1", 65537),
            m_mapAppTwoCharSegFeat0SegFeat1("AppTwoCharSegFeat0SegFeat1", 65537),
            m_mapAppTwoCharPosFeat0PosFeat1("AppTwoCharPosFeat0PosFeat1", 65537),
            m_mapAppFirstChar0SegFeat1("AppFirstChar0SegFeat1", 65537),
            m_mapAppFirstChar0PosFeat1("AppFirstChar0PosFeat1", 65537),
            m_mapAppFirstChar0SegPosFeat1("AppFirstChar0SegPosFeat1", 65537),
            m_mapAppFirstChar0SegFeat0SegFeat1("AppFirstChar0SegFeat0SegFeat1", 65537),
            m_mapAppFirstChar0PosFeat0PosFeat1("AppFirstChar0PosFeat0PosFeat1", 65537),
            m_mapAppSegFeat0("AppSegFeat0", 65537),
            m_mapAppPosFeat0("AppPosFeat0", 65537),
            m_mapAppSegPosFeat0("AppSegPosFeat0", 65537),
            m_mapAppFirstChar0SegFeat0("AppFirstChar0SegFeat0", 65537),
            m_mapAppFirstChar0PosFeat0("AppFirstChar0PosFeat0", 65537),
            m_mapAppFirstChar0SegPosFeat0("AppFirstChar0SegPosFeat0", 65537),
            m_mapSEPB("SEPB", 65537),
            m_mapSEPBTagByChar("SEPBTagByChar", 65537),
            m_mapSEPBLastTagByTag("SEPBLastTagByTag", 65537),
            m_mapSEPBSeenWords("SEPBSeenWords", 65537),
            m_mapSEPBTwoChars("SEPBTwoChars", 65537),
            m_mapSEPA("SEPA", 65537),
            m_mapSEPATagByChar("SEPATagByChar", 65537),
            m_mapSEPALastTagByTag("SEPALastTagByTag", 65537),
            m_mapSEPASeenWords("SEPASeenWords", 65537),
            m_mapSEPATwoChars("SEPATwoChars", 65537),
            m_mapAPPB("APPB", 65537),
            m_mapAPPBTagByChar("APPBTagByChar", 65537),
            m_mapAPPBConsecutiveChars("APPBConsecutiveChars", 65537),
            m_mapAPPA("APPA", 65537),
            m_mapAPPATagByChar("APPATagByChar", 65537),
            m_mapAPPAConsecutiveChars("APPAConsecutiveChars", 65537)
   { 
