...
/**************************************************************** 
 *                                                              *
 * Specific implementation by the viterbi decoder               *
 *                                                              *
 * Yue Zhang, 2007                                              *
 *                                                              *
 ****************************************************************/

#ifndef SEGMENTOR_VITERBI_IMPL_H
...
class CSegmentorImpl {
   ...
   public:
      CSegmentorImpl() {
         m_Chart = new CStateItem[MAX_SENTENCE_SIZE*MAX_SENTENCE_SIZE];
      }
      virtual ~CSegmentorImpl() { delete[] m_Chart; }
      int find_index(const int &start, const int &end) { return start*MAX_SENTENCE_SIZE+end; }
};
