...
#define iterate_templates(left,right) \
   ...
   left m_mapSepStackedPrevCurChar right\
   left m_mapSepStackedCurCurChar right\
   left m_mapSepStackedNextCurChar right\
   left m_mapSepStackedCurChar right\
   left m_mapSepStackedPrevCurCurChar right\
   left m_mapSepStackedNextCurCurChar right\
   left m_mapAppStackedPrevCurChar right\
   left m_mapAppStackedCurCurChar right\
   left m_mapAppStackedNextCurChar right\
   left m_mapAppStackedCurChar right\
   left m_mapAppStackedPrevCurCurChar right\
   left m_mapAppStackedNextCurCurChar right
...
public:
   ...
   typedef CScoreMapType< int, SCORE_TYPE > CNormalIntMap;
   ...
   // stacked features
   CWordIntMap m_mapSepStackedPrevCurChar;
   CWordIntMap m_mapSepStackedCurCurChar;
   CWordIntMap m_mapSepStackedNextCurChar;
   CNormalIntMap m_mapSepStackedCurChar;
   CWordIntMap m_mapSepStackedPrevCurCurChar;
   CWordIntMap m_mapSepStackedNextCurCurChar;

   CWordIntMap m_mapAppStackedPrevCurChar;
   CWordIntMap m_mapAppStackedCurCurChar;
   CWordIntMap m_mapAppStackedNextCurChar;
   CNormalIntMap m_mapAppStackedCurChar;
   CWordIntMap m_mapAppStackedPrevCurCurChar;
   CWordIntMap m_mapAppStackedNextCurCurChar;
...
public:
   CWeight() : m_mapCharUnigram("CharUnigram", DEFAULT_TABLE_SIZE, false),
               ...
               m_mapSepStackedPrevCurChar("SepStackedPrevCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapSepStackedCurCurChar("SepStackedCurCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapSepStackedNextCurChar("SepStackedNextCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapSepStackedCurChar("SepStackedCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapSepStackedPrevCurCurChar("SepStackedPrevCurCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapSepStackedNextCurCurChar("SepStackedNextCurCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapAppStackedPrevCurChar("AppStackedPrevCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapAppStackedCurCurChar("AppStackedCurCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapAppStackedNextCurChar("AppStackedNextCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapAppStackedCurChar("AppStackedCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapAppStackedPrevCurCurChar("AppStackedPrevCurCurChar", DEFAULT_TABLE_SIZE, false),
               m_mapAppStackedNextCurCurChar("AppStackedNextCurCurChar", DEFAULT_TABLE_SIZE, false),
